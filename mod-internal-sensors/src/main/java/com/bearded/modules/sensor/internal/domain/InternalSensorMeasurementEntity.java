...
public class InternalSensorMeasurementEntity implements com.bearded.common.persistance.ParseableJson, java.lang.Comparable<InternalSensorMeasurementEntity> {
    ...
    public InternalSensorMeasurementEntity(Long id, long measurement_series_id, Long location_id, float medianSensorValue, String startTimestamp, String endTimestamp, short binSize) {
        this.id = id;
